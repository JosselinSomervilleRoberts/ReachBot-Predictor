...
def smooth_skeleton_dice_loss(ground_truth: torch.Tensor, prediction: torch.Tensor, iterations: int = 10,
    ...
    ground_truth_border = apply_smooth_gaussian_diffusion(ground_truth_skeleton, border_size, sigma)
    prediction_border = apply_smooth_gaussian_diffusion(prediction_skeleton, border_size, sigma)
