...
class BaseModel(_BaseModel):
    ...
    def __init__(
        ...
        data_preprocessor.setdefault("type", "mmselfsup.SelfSupDataPreprocessor")
    ...
    def with_target_generator(self) -> bool:
        ...
        return hasattr(self, "target_generator") and self.target_generator is not None
    ...
    def loss(self, inputs: torch.Tensor, data_samples: List[SelfSupDataSample]) -> dict:
