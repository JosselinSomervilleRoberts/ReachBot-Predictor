...
# learning policy
param_scheduler = [
    dict(type="PolyLR", eta_min=1e-4, power=0.9, by_epoch=False, begin=0, end=60000)
]
# runtime settings
total_iters = 60000
train_cfg = dict(type="IterBasedTrainLoop", max_iters=total_iters, val_interval=4000)
